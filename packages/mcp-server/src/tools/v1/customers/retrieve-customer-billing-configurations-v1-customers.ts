...
export const tool: Tool = {
  name: 'retrieve_customer_billing_configurations_v1_customers',
  description:
...
export const handler = async (client: Metronome, args: Record<string, unknown> | undefined) => {
  ...
  return asTextContentResult(
    await maybeFilter(jq_filter, await client.v1.customers.retrieveCustomerBillingConfigurations(body)),
  );
};

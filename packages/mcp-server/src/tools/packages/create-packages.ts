...
export const tool: Tool = {
  ...
  inputSchema: {
    ...
    properties: {
      ...
      billing_anchor_date: {
        type: 'string',
        enum: ['contract_start_date', 'first_billing_period'],
      },
      billing_provider: {
        type: 'string',
              ...
              properties: {
                schedule_items: {
                  ...
                  items: {
                    ...
                    required: ['amount', 'duration', 'starting_at_offset'],
                  },
                },
                credit_type_id: {
                  type: 'string',
      ...
      overrides: {
        ...
        items: {
          ...
          required: ['override_specifiers', 'starting_offset'],
        },
      },
      ...
      priority: {
        type: 'number',
        description: 'Priority of the generated contract.',
      },
      rate_card_alias: {
        type: 'string',
      ...
      recurring_commits: {
        ...
        items: {
          ...
          required: ['access_amount', 'commit_duration', 'priority', 'product_id', 'starting_offset'],
        },
      },
      recurring_credits: {
        type: 'array',
      ...
      usage_statement_schedule: {
        ...
        properties: {
          ...
          day: {
            ...
            enum: ['FIRST_OF_MONTH', 'CONTRACT_START'],
          },
...
export const handler = async (client: Metronome, args: Record<string, unknown> | undefined) => {
  ...
  return asTextContentResult(await client.packages.create(body));
};

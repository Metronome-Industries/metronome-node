...
import create_v2_notifications from './v2/notifications/create-v2-notifications';
import retrieve_v2_notifications from './v2/notifications/retrieve-v2-notifications';
import archive_v2_notifications from './v2/notifications/archive-v2-notifications';
import edit_v2_notifications from './v2/notifications/edit-v2-notifications';
import list_offset_v2_notifications from './v2/notifications/list-offset-v2-notifications';
import list_system_v2_notifications from './v2/notifications/list-system-v2-notifications';
...
import list_customers_v1_plans from './v1/plans/list-customers-v1-plans';
...
addEndpoint(create_v2_notifications);
addEndpoint(retrieve_v2_notifications);
addEndpoint(archive_v2_notifications);
addEndpoint(edit_v2_notifications);
addEndpoint(list_offset_v2_notifications);
addEndpoint(list_system_v2_notifications);

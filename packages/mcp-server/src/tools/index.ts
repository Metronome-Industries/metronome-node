...
import retrieve_customer_billing_configurations_v1_customers from './v1/customers/retrieve-customer-billing-configurations-v1-customers';
import set_customer_billing_configurations_v1_customers from './v1/customers/set-customer-billing-configurations-v1-customers';
...
addEndpoint(retrieve_customer_billing_configurations_v1_customers);
addEndpoint(set_customer_billing_configurations_v1_customers);

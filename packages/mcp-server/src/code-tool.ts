...
const remoteStainlessHandler = async (
  ...
  METRONOME_BEARER_TOKEN: requireValue(readEnv('METRONOME_BEARER_TOKEN') ?? client.bearerToken, 'set METRONOME_BEARER_TOKEN environment variable or provide bearerToken client option'),

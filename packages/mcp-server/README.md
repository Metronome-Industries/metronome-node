...
```json
{
  "mcpServers": {
    "metronome_sdk_api": {
      "command": "npx",
      "args": ["-y", "@metronome/sdk-mcp", "--client=claude", "--tools=dynamic"],
      "env": {
...
import { server, endpoints, init } from "@metronome/sdk-mcp/server";

// import a specific tool
import retrieveV2Contracts from "@metronome/sdk-mcp/tools/v2/contracts/retrieve-v2-contracts";

...
export class Alerts extends APIResource {
   ...
   * for await (const alertListResponse of client.v1.customers.alerts.list(
   *   { customer_id: '9b85c1c1-5238-4f2a-a409-61412905e1e1' },
   * )) {
   *   // ...
   * }
  ...
  ): Core.PagePromise<AlertListResponsesCursorPageWithoutLimit, AlertListResponse> {
    const { next_page, ...body } = params;
    return this._client.getAPIList('/v1/customer-alerts/list', AlertListResponsesCursorPageWithoutLimit, {
      query: { next_page },
      body,
      method: 'post',
      ...options,
...
export class AlertListResponsesCursorPageWithoutLimit extends CursorPageWithoutLimit<AlertListResponse> {}

export interface AlertRetrieveResponse {
  data: AlertRetrieveResponse.Data;
}
...
Alerts.AlertListResponsesCursorPageWithoutLimit = AlertListResponsesCursorPageWithoutLimit;

...
import { CreditsCursorPage } from '../../shared';
...
export class Credits extends APIResource {
  ...
  ): Core.PagePromise<CreditsCursorPage, Shared.Credit> {
    return this._client.getAPIList('/v1/contracts/customerCredits/list', CreditsCursorPage, {
      body,
      method: 'post',
      ...options,
    });
...
export interface CreditListParams extends CursorPageParams {
  customer_id: string;

...
export class Credits extends APIResource {
   ...
   * for await (const creditListResponse of client.v1.customers.credits.list(
   *   {
   *     customer_id: '13117714-3f05-48e5-a6e9-a66093f13b4d',
  ...
  ): Core.PagePromise<CreditListResponsesBodyCursorPage, CreditListResponse> {
    return this._client.getAPIList('/v1/contracts/customerCredits/list', CreditListResponsesBodyCursorPage, {
      body,
      method: 'post',
      ...options,
    });
...
export class CreditListResponsesBodyCursorPage extends BodyCursorPage<CreditListResponse> {}
...
export interface CreditListResponse {
  ...
  product: CreditListResponse.Product;
   ...
   */
  access_schedule?: CreditListResponse.AccessSchedule;
  ...
  contract?: CreditListResponse.Contract;
   ...
   */
  hierarchy_configuration?: CreditListResponse.HierarchyConfiguration;
   ...
   */
  ledger?: Array<
    | CreditListResponse.UnionMember0
    | CreditListResponse.UnionMember1
    | CreditListResponse.UnionMember2
    | CreditListResponse.UnionMember3
    | CreditListResponse.UnionMember4
    | CreditListResponse.UnionMember5
    | CreditListResponse.UnionMember6
  >;
   ...
   */
  specifiers?: Array<CreditListResponse.Specifier>;
...
Credits.CreditListResponsesBodyCursorPage = CreditListResponsesBodyCursorPage;

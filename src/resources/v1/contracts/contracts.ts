...
export class Contracts extends APIResource {
  ...
  listBalances(
    ...
    options?: Core.RequestOptions,
  ): Core.PagePromise<ContractListBalancesResponsesCursorPage, ContractListBalancesResponse> {
...
export class ContractListBalancesResponsesCursorPage extends CursorPage<ContractListBalancesResponse> {}
...
export interface ContractListBalancesParams extends CursorPageParams {
  customer_id: string;
...
Contracts.ContractListBalancesResponsesCursorPage = ContractListBalancesResponsesCursorPage;
...
export declare namespace Contracts {
  export {
    ...
    ContractListBalancesResponsesCursorPage as ContractListBalancesResponsesCursorPage,

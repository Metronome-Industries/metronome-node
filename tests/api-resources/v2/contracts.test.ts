...
describe('resource contracts', () => {
  test('retrieve: only required params', async () => {
    const responsePromise = client.v2.contracts.retrieve({ contract_id: 'd7abd0cd-4ae9-4db7-8676-e986a4ebd8dc', customer_id: '13117714-3f05-48e5-a6e9-a66093f13b4d' });
  ...
  test('edit: only required params', async () => {
    const responsePromise = client.v2.contracts.edit({ contract_id: 'd7abd0cd-4ae9-4db7-8676-e986a4ebd8dc', customer_id: '13117714-3f05-48e5-a6e9-a66093f13b4d' });
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test('editCommit: only required params', async () => {
    const responsePromise = client.v2.contracts.editCommit({ commit_id: '5e7e82cf-ccb7-428c-a96f-a8e4f67af822', customer_id: '4c91c473-fc12-445a-9c38-40421d47023f' });
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test('editCredit: only required params', async () => {
    const responsePromise = client.v2.contracts.editCredit({ credit_id: '5e7e82cf-ccb7-428c-a96f-a8e4f67af822', customer_id: '4c91c473-fc12-445a-9c38-40421d47023f' });
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test('getEditHistory: only required params', async () => {
    const responsePromise = client.v2.contracts.getEditHistory({ contract_id: 'd7abd0cd-4ae9-4db7-8676-e986a4ebd8dc', customer_id: '13117714-3f05-48e5-a6e9-a66093f13b4d' });
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);

...
describe('resource offset', () => {
  ...
  test('retrieve: only required params', async () => {
    const responsePromise = client.v2.notifications.offset.retrieve({ id: 'd7abd0cd-4ae9-4db7-8676-e986a4ebd8dc' });
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test('retrieve: required and optional params', async () => {
    const response = await client.v2.notifications.offset.retrieve({ id: 'd7abd0cd-4ae9-4db7-8676-e986a4ebd8dc' });
  });
  ...
  test('list: request options and params are passed correctly', async () => {
    ...
    await expect(client.v2.notifications.offset.list({
  ...
  test('archive: only required params', async () => {
    const responsePromise = client.v2.notifications.offset.archive({ id: 'd7abd0cd-4ae9-4db7-8676-e986a4ebd8dc' });
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test('edit: only required params', async () => {
    const responsePromise = client.v2.notifications.offset.edit({ policy: { offset: 'P2D', type: 'contract.start' } });
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);

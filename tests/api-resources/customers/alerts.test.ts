...
describe('resource alerts', () => {
  test('retrieve: only required params', async () => {
    const responsePromise = client.customers.alerts.retrieve({
  ...
  test('retrieve: required and optional params', async () => {
    const response = await client.customers.alerts.retrieve({
      alert_id: '8deed800-1b7a-495d-a207-6c52bac54dc9',
      customer_id: '9b85c1c1-5238-4f2a-a409-61412905e1e1',
    });
  });
  ...
  test('list: only required params', async () => {
    const responsePromise = client.customers.alerts.list({
      customer_id: '9b85c1c1-5238-4f2a-a409-61412905e1e1',
    });
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
  ...
  test('reset: only required params', async () => {
    const responsePromise = client.customers.alerts.reset({
  ...
  test('reset: required and optional params', async () => {
    const response = await client.customers.alerts.reset({
      alert_id: '5e8691bf-b22a-4672-922d-f80eee940f01',
      customer_id: '4c83caf3-8af4-44e2-9aeb-e290531726d9',
    });
  });

...
describe('resource customers', () => {
  ...
  test('retrieve: only required params', async () => {
    const responsePromise = client.customers.retrieve({
  ...
  test('retrieve: required and optional params', async () => {
    const response = await client.customers.retrieve({ customer_id: 'd7abd0cd-4ae9-4db7-8676-e986a4ebd8dc' });
  });
  ...
  test('listBillableMetrics: only required params', async () => {
    const responsePromise = client.customers.listBillableMetrics({
      customer_id: 'd7abd0cd-4ae9-4db7-8676-e986a4ebd8dc',
    });
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
  ...
  test('listCosts: only required params', async () => {
    const responsePromise = client.customers.listCosts({
      customer_id: 'd7abd0cd-4ae9-4db7-8676-e986a4ebd8dc',
  ...
  test('listCosts: required and optional params', async () => {
    const response = await client.customers.listCosts({
      customer_id: 'd7abd0cd-4ae9-4db7-8676-e986a4ebd8dc',
      ending_before: '2019-12-27T18:11:19.117Z',
      starting_on: '2019-12-27T18:11:19.117Z',
      limit: 1,
  ...
  test('setIngestAliases: only required params', async () => {
    const responsePromise = client.customers.setIngestAliases({
      customer_id: 'd7abd0cd-4ae9-4db7-8676-e986a4ebd8dc',
      ingest_aliases: ['team@example.com'],
    });
    const rawResponse = await responsePromise.asResponse();
  ...
  test('setIngestAliases: required and optional params', async () => {
    const response = await client.customers.setIngestAliases({
      customer_id: 'd7abd0cd-4ae9-4db7-8676-e986a4ebd8dc',
      ingest_aliases: ['team@example.com'],
    });
  });
  ...
  test('setName: only required params', async () => {
    const responsePromise = client.customers.setName({
      customer_id: 'd7abd0cd-4ae9-4db7-8676-e986a4ebd8dc',
      name: 'Example, Inc.',
    });
    const rawResponse = await responsePromise.asResponse();
  ...
  test('setName: required and optional params', async () => {
    const response = await client.customers.setName({
      customer_id: 'd7abd0cd-4ae9-4db7-8676-e986a4ebd8dc',
      name: 'Example, Inc.',
    });
  });
  ...
  test('updateConfig: only required params', async () => {
    const responsePromise = client.customers.updateConfig({
      customer_id: 'd7abd0cd-4ae9-4db7-8676-e986a4ebd8dc',
    });
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
  ...
  test('updateConfig: required and optional params', async () => {
    const response = await client.customers.updateConfig({
      customer_id: 'd7abd0cd-4ae9-4db7-8676-e986a4ebd8dc',

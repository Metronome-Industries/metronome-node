...
describe('resource rates', () => {
  test('list: only required params', async () => {
    const responsePromise = client.v1.contracts.rateCards.rates.list({ at: '2024-01-01T00:00:00.000Z', rate_card_id: 'f3d51ae8-f283-44e1-9933-a3cf9ad7a6fe' });
  ...
  test('list: required and optional params', async () => {
    const response = await client.v1.contracts.rateCards.rates.list({
  ...
  test('add: only required params', async () => {
    const responsePromise = client.v1.contracts.rateCards.rates.add({
    entitled: true,
  ...
  test('addMany: only required params', async () => {
    const responsePromise = client.v1.contracts.rateCards.rates.addMany({ rate_card_id: 'd7abd0cd-4ae9-4db7-8676-e986a4ebd8dc', rates: [{
    entitled: true,
    product_id: '13117714-3f05-48e5-a6e9-a66093f13b4d',
    rate_type: 'FLAT',
    starting_at: '2020-01-01T00:00:00.000Z',
  ...
  test('addMany: required and optional params', async () => {
    const response = await client.v1.contracts.rateCards.rates.addMany({ rate_card_id: 'd7abd0cd-4ae9-4db7-8676-e986a4ebd8dc', rates: [{
    entitled: true,
    product_id: '13117714-3f05-48e5-a6e9-a66093f13b4d',
    rate_type: 'FLAT',
    starting_at: '2020-01-01T00:00:00.000Z',

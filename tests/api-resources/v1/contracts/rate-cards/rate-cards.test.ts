...
describe('resource rateCards', () => {
  ...
  test('create: required and optional params', async () => {
    ...
    credit_type_conversions: [{ custom_credit_type_id: '2714e483-4ff1-48e4-9e25-ac732e8f24f2', fiat_per_custom_credit: 2 }],
  ...
  test('retrieve: only required params', async () => {
    const responsePromise = client.v1.contracts.rateCards.retrieve({ id: 'f3d51ae8-f283-44e1-9933-a3cf9ad7a6fe' });
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test('retrieve: required and optional params', async () => {
    const response = await client.v1.contracts.rateCards.retrieve({ id: 'f3d51ae8-f283-44e1-9933-a3cf9ad7a6fe' });
  });

  test('update: only required params', async () => {
    const responsePromise = client.v1.contracts.rateCards.update({ rate_card_id: 'd7abd0cd-4ae9-4db7-8676-e986a4ebd8dc' });
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test('update: required and optional params', async () => {
    ...
    add_credit_type_conversions: [{ custom_credit_type_id: '182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e', fiat_per_custom_credit: 0 }],
    aliases: [{
    name: 'name',
    ending_before: '2019-12-27T18:11:19.117Z',
    starting_at: '2019-12-27T18:11:19.117Z',
  ...
  test('list: request options and params are passed correctly', async () => {
    ...
    await expect(client.v1.contracts.rateCards.list({
    limit: 1,
    next_page: 'next_page',
    body: {},
  ...
  test('archive: only required params', async () => {
    const responsePromise = client.v1.contracts.rateCards.archive({ id: '12b21470-4570-40df-8998-449d0b0bc52f' });
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test('archive: required and optional params', async () => {
    const response = await client.v1.contracts.rateCards.archive({ id: '12b21470-4570-40df-8998-449d0b0bc52f' });
  });

  test('retrieveRateSchedule: only required params', async () => {
    const responsePromise = client.v1.contracts.rateCards.retrieveRateSchedule({ rate_card_id: 'f3d51ae8-f283-44e1-9933-a3cf9ad7a6fe', starting_at: '2024-01-01T00:00:00.000Z' });
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);

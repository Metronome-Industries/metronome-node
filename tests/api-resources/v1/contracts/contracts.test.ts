...
describe('resource contracts', () => {
  test('create: only required params', async () => {
    const responsePromise = client.v1.contracts.create({ customer_id: '13117714-3f05-48e5-a6e9-a66093f13b4d', starting_at: '2020-01-01T00:00:00.000Z' });
  ...
  test('create: required and optional params', async () => {
    ...
    parent: { contract_id: '182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e', customer_id: '182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e' },
    ...
    threshold_balance_specifiers: [{ exclude: [{ custom_field_filters: [{
    entity: 'Commit',
    key: 'key',
    value: 'value',
  }] }] }],
    ...
    subscription_rate: { billing_frequency: 'MONTHLY', product_id: '182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e' },
    billing_cycle_config: { anchor_date: '2019-12-27T18:11:19.117Z', invoice_placement: 'ON_SCHEDULED_INVOICE' },
    custom_fields: { foo: 'string' },
    description: 'description',
    ending_before: '2019-12-27T18:11:19.117Z',
    initial_quantity: 0,
  ...
  test('retrieve: only required params', async () => {
    const responsePromise = client.v1.contracts.retrieve({ contract_id: 'd7abd0cd-4ae9-4db7-8676-e986a4ebd8dc', customer_id: '13117714-3f05-48e5-a6e9-a66093f13b4d' });
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test('createHistoricalInvoices: only required params', async () => {
    const responsePromise = client.v1.contracts.createHistoricalInvoices({ invoices: [{
    contract_id: 'd7abd0cd-4ae9-4db7-8676-e986a4ebd8dc',
  ...
  test('createHistoricalInvoices: required and optional params', async () => {
    const response = await client.v1.contracts.createHistoricalInvoices({ invoices: [{
    contract_id: 'd7abd0cd-4ae9-4db7-8676-e986a4ebd8dc',
    credit_type_id: '2714e483-4ff1-48e4-9e25-ac732e8f24f2',
    customer_id: '13117714-3f05-48e5-a6e9-a66093f13b4d',
    exclusive_end_date: '2020-02-01T00:00:00.000Z',
  ...
  test('getNetBalance: only required params', async () => {
    const responsePromise = client.v1.contracts.getNetBalance({ customer_id: '13117714-3f05-48e5-a6e9-a66093f13b4d' });
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test('listBalances: only required params', async () => {
    const responsePromise = client.v1.contracts.listBalances({ customer_id: '13117714-3f05-48e5-a6e9-a66093f13b4d' });
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test('listSeatBalances: only required params', async () => {
    const responsePromise = client.v1.contracts.listSeatBalances({ contract_id: 'd7abd0cd-4ae9-4db7-8676-e986a4ebd8dc', customer_id: '13117714-3f05-48e5-a6e9-a66093f13b4d' });
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test('retrieveRateSchedule: only required params', async () => {
    const responsePromise = client.v1.contracts.retrieveRateSchedule({ contract_id: 'd7abd0cd-4ae9-4db7-8676-e986a4ebd8dc', customer_id: '13117714-3f05-48e5-a6e9-a66093f13b4d' });
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test('updateEndDate: only required params', async () => {
    const responsePromise = client.v1.contracts.updateEndDate({ contract_id: 'd7abd0cd-4ae9-4db7-8676-e986a4ebd8dc', customer_id: '13117714-3f05-48e5-a6e9-a66093f13b4d' });
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);

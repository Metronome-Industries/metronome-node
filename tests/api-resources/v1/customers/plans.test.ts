...
describe('resource plans', () => {
  test('list: only required params', async () => {
    const responsePromise = client.v1.customers.plans.list({ customer_id: 'd7abd0cd-4ae9-4db7-8676-e986a4ebd8dc' });
  ...
  test('end: only required params', async () => {
    const responsePromise = client.v1.customers.plans.end({ customer_id: 'd7abd0cd-4ae9-4db7-8676-e986a4ebd8dc', customer_plan_id: '7aa11640-0703-4600-8eb9-293f535a6b74' });
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test('listPriceAdjustments: only required params', async () => {
    const responsePromise = client.v1.customers.plans.listPriceAdjustments({ customer_id: 'd7abd0cd-4ae9-4db7-8676-e986a4ebd8dc', customer_plan_id: '7aa11640-0703-4600-8eb9-293f535a6b74' });
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);

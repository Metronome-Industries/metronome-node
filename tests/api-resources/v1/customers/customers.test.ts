...
describe('resource customers', () => {
  ...
  test('retrieve: only required params', async () => {
    const responsePromise = client.v1.customers.retrieve({ customer_id: 'd7abd0cd-4ae9-4db7-8676-e986a4ebd8dc' });
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test('retrieve: required and optional params', async () => {
    const response = await client.v1.customers.retrieve({ customer_id: 'd7abd0cd-4ae9-4db7-8676-e986a4ebd8dc' });
  });
  ...
  test('list: request options and params are passed correctly', async () => {
    ...
    await expect(client.v1.customers.list({
    customer_ids: ['string'],
  ...
  test('archiveBillingConfigurations: only required params', async () => {
    const responsePromise = client.v1.customers.archiveBillingConfigurations({ customer_billing_provider_configuration_ids: ['4db51251-61de-4bfe-b9ce-495e244f3491', '4db51251-61de-4bfe-b9ce-495e244f3491'], customer_id: '20a060d1-aa80-41d4-8bb2-4f3091b93903' });
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test('archiveBillingConfigurations: required and optional params', async () => {
    const response = await client.v1.customers.archiveBillingConfigurations({ customer_billing_provider_configuration_ids: ['4db51251-61de-4bfe-b9ce-495e244f3491', '4db51251-61de-4bfe-b9ce-495e244f3491'], customer_id: '20a060d1-aa80-41d4-8bb2-4f3091b93903' });
  });

  test('listBillableMetrics: only required params', async () => {
    const responsePromise = client.v1.customers.listBillableMetrics({ customer_id: 'd7abd0cd-4ae9-4db7-8676-e986a4ebd8dc' });
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test('previewEvents: only required params', async () => {
    const responsePromise = client.v1.customers.previewEvents({ customer_id: 'd7abd0cd-4ae9-4db7-8676-e986a4ebd8dc', events: [{ event_type: 'heartbeat' }] });
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test('retrieveBillingConfigurations: only required params', async () => {
    const responsePromise = client.v1.customers.retrieveBillingConfigurations({ customer_id: '6a37bb88-8538-48c5-b37b-a41c836328bd' });
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test('setBillingConfigurations: required and optional params', async () => {
    const response = await client.v1.customers.setBillingConfigurations({ data: [{
    billing_provider: 'stripe',
  ...
  test('setIngestAliases: only required params', async () => {
    const responsePromise = client.v1.customers.setIngestAliases({ customer_id: 'd7abd0cd-4ae9-4db7-8676-e986a4ebd8dc', ingest_aliases: ['team@example.com'] });
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test('setIngestAliases: required and optional params', async () => {
    const response = await client.v1.customers.setIngestAliases({ customer_id: 'd7abd0cd-4ae9-4db7-8676-e986a4ebd8dc', ingest_aliases: ['team@example.com'] });
  });

  test('setName: only required params', async () => {
    const responsePromise = client.v1.customers.setName({ customer_id: 'd7abd0cd-4ae9-4db7-8676-e986a4ebd8dc', name: 'Example, Inc.' });
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test('setName: required and optional params', async () => {
    const response = await client.v1.customers.setName({ customer_id: 'd7abd0cd-4ae9-4db7-8676-e986a4ebd8dc', name: 'Example, Inc.' });
  });

  test('updateConfig: only required params', async () => {
    const responsePromise = client.v1.customers.updateConfig({ customer_id: 'd7abd0cd-4ae9-4db7-8676-e986a4ebd8dc' });
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
